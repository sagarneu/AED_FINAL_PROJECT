...
public class NGOAdministratorProcessWorkRequestJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        sendRequestToDirectoryBtn.setBackground(new java.awt.Color(0, 0, 0));
        sendRequestToDirectoryBtn.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        sendRequestToDirectoryBtn.setForeground(new java.awt.Color(255, 255, 255));
    ...
    private void sendRequestToDirectoryBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendRequestToDirectoryBtnActionPerformed
        ...
        if (message.equals("")) {
            ...
            if (dialogResult == JOptionPane.YES_OPTION) {
                ...
                JOptionPane.showMessageDialog(null, "Request to Director Successfully");
                messageTxt.setText("");
