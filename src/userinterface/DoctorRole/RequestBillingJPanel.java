...
public class RequestBillingJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jLabel10);
        jLabel10.setBounds(380, 250, 75, 17);
        ...
        add(jLabel8);
        jLabel8.setBounds(89, 290, 120, 17);
        ...
        add(jLabel3);
        jLabel3.setBounds(300, 360, 162, 17);

        jLabel4.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel4.setText("Consultaion Charges (USD) :");
        add(jLabel4);
        jLabel4.setBounds(209, 390, 190, 21);
        ...
        add(jLabel5);
        jLabel5.setBounds(228, 460, 180, 21);
        add(medChrgTxt);
        ...
        add(jLabel11);
        jLabel11.setBounds(228, 420, 170, 21);
        ...
        add(jLabel12);
        jLabel12.setBounds(207, 490, 200, 17);
        add(miscChrgTxt);
        miscChrgTxt.setBounds(410, 490, 82, 23);

        sndBillReqBtn.setBackground(new java.awt.Color(0, 0, 0));
        sndBillReqBtn.setFont(new java.awt.Font("Times New Roman", 1, 12)); // NOI18N
        sndBillReqBtn.setForeground(new java.awt.Color(255, 255, 255));
        ...
        add(sndBillReqBtn);
        sndBillReqBtn.setBounds(300, 540, 142, 32);
    ...
    private void sndBillReqBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sndBillReqBtnActionPerformed
        ...
        if (consultationCharge.equals("") || labChargesStr.equals("") || miscellaneouschargesStr.equals("") || medicationChargesStr.equals("")) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Please provide an Integer value for Consultation Charges");
                return;
            }
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Please type an Integer value for Lab Charges");
                return;
            }
            try {
                Integer.parseInt(miscellaneouschargesStr);
            } catch (NumberFormatException e) {
                JOptionPane.showMessageDialog(null, "Please type an Integer value for Miscellaneous charges");
                return;
            }
            try {
                Integer.parseInt(medicationChargesStr);
            } catch (NumberFormatException e) {
                JOptionPane.showMessageDialog(null, "Please type an Integer value for Medication charges");
                return;
            }
    ...
    private void pplTbl() {
        ...
        fstNmTxt.setText(pntTrtmntWrkReq.getPat().getPatientFirstName());
        lstNmTxt.setText(pntTrtmntWrkReq.getPat().getPatientLastName());
        pntIdTxt.setText(String.valueOf(pntTrtmntWrkReq.getPat().getPatientId()));
        asgndDocTxt.setText(pntTrtmntWrkReq.getAssignedDoc().getEmp().getEmployeeName());
