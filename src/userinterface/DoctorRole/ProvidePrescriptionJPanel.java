...
public class ProvidePrescriptionJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jLabel1);
        jLabel1.setBounds(320, 30, 214, 29);

        jLabel6.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel6.setText("PATIENT INFORMATION");
        add(jLabel6);
        jLabel6.setBounds(327, 98, 180, 30);
        ...
        add(jLabel8);
        jLabel8.setBounds(41, 224, 200, 17);
        ...
        add(jLabel4);
        jLabel4.setBounds(63, 186, 180, 17);
        ...
        sbmtBtn.setBackground(new java.awt.Color(0, 0, 0));
        sbmtBtn.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        sbmtBtn.setForeground(new java.awt.Color(255, 255, 255));
        ...
        add(sbmtBtn);
        sbmtBtn.setBounds(390, 370, 80, 24);
        ...
        add(backJButton);
        backJButton.setBounds(29, 11, 90, 24);
    ...
    private void pplTbl() {
        fstNmTxt.setText(req.getPat().getPatientFirstName());
        lstNmTxt.setText(req.getPat().getPatientLastName());
       // txtBirthDate1.setText(String.valueOf(request.getPatient().getDateOfBirth()));
        ageTxt.setText(String.valueOf(req.getPat().getPatientAge()));
        medCondTxt.setText(req.getReasonForVisit());
        asgndDocTxt.setText(req.getAssignedDoc().getEmp().getEmployeeName());
