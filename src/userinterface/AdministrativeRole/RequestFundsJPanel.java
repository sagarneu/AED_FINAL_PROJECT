...
public class RequestFundsJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnSendFundRequest.setBackground(new java.awt.Color(0, 0, 0));
        ...
        add(jLabel5);
        jLabel5.setBounds(40, 240, 137, 15);
    ...
    private void btnSendFundRequestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSendFundRequestActionPerformed
        ...
        if (location.equals("") || population.equals("") || amount.equals("")) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Please type an Integer for population field");
                return;
            }
            try {
                Double.parseDouble(amount);
            } catch (NumberFormatException e) {
                JOptionPane.showMessageDialog(null, "Please type an Integer value for amount field");
                return;
            }
