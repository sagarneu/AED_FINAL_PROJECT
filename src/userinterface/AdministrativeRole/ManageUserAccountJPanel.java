...
public class ManageUserAccountJPanel extends javax.swing.JPanel {
    ...
    public void pplEmpCmbx(Organization organization) {
        ...
        for (Employee employee : organization.getEmpDir().getEmployeeList()) {
    ...
    private void createUserJButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_createUserJButtonActionPerformed
        ...
        if (!passwordPatternCorrect()) {
            JOptionPane.showMessageDialog(null, "Password field should be at least 6 Characters "
                    + "numbers with a combination of number, uppercase letter, "
        ...
        if (!password.equals(rePassword)) {
            ...
            for (UserAccount userAccount : userAccountList) {
                if (userAccount.getUname().equals(userName)) {
                    JOptionPane.showMessageDialog(null, "username field is already taken");
                    nameJTextField.setBorder(BorderFactory.createLineBorder(Color.RED));
                    return;
                }
            }
