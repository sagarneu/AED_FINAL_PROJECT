...
public class ProcessRequestJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jLabel2);
        jLabel2.setBounds(199, 98, 90, 15);
        ...
        add(txtMessage);
        txtMessage.setBounds(309, 248, 140, 23);
        ...
        add(btnAccept);
        btnAccept.setBounds(121, 286, 309, 34);
    ...
    private void btnAcceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAcceptActionPerformed
        ...
        if (message.equals("")) {
            ...
            if (dialogResult == JOptionPane.YES_OPTION) {
                ...
                insuranceWorkRequest.setAgent(account.getEmp().getEmployeeName());
