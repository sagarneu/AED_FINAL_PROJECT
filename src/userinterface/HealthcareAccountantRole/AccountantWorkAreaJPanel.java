...
public class AccountantWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        createAppmnt.setBackground(new java.awt.Color(0, 0, 0));
        createAppmnt.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        createAppmnt.setForeground(new java.awt.Color(255, 255, 255));
        ...
        prcsMedclBillingsBtn.setBackground(new java.awt.Color(0, 0, 0));
        prcsMedclBillingsBtn.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        prcsMedclBillingsBtn.setForeground(new java.awt.Color(255, 255, 255));
    ...
    public void pplAllPtntsTbl() {
        ...
        for (Patient ptnt : patients) {
            ...
            row[0] = ptnt;
            row[1] = ptnt.getPatientFirstName() + " " + ptnt.getPatientLastName();
            row[2] = ptnt.getPhone();
            row[3] = ptnt.getAddress();
            row[4] = ptnt.isIsTreatmentdone() ? "Treatment Complete" : "Treatment In Progress";
            row[5] = ptnt.getAptDate();
            row[6] = ptnt.getDoctorType();
            dtm.addRow(row);
        }
