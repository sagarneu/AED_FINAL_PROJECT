...
public class CreateAppointmentJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnFindPatient.setBackground(new java.awt.Color(0, 0, 0));
        ...
        btnResetPolicyNum.setBackground(new java.awt.Color(0, 0, 0));
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        if (txtFirstName.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Please provide first name field");
            return;
        }
        if (txtLastName.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Please provide last name field");
            return;
        }
        if (buttonGroup2.isSelected(null)) {
            JOptionPane.showMessageDialog(null, "Please select gender field");
            return;
        }
        if (txtHomePhone.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Please provide phone field");
            return;
        }
        if (txtSSN.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Please provide SSN field");
            return;
        }
        if (txtAge.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Please provide age field");
            return;
        }
        if (txtAddress.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Please provide address field");
            return;
        }
        
        if (buttonGroup1.isSelected(null)) {
            JOptionPane.showMessageDialog(null, "Please choose if Patient is covered by Insurance");
            return;
        }
        
        if (txtReasonForVisit.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Please provide reason for your visit");
            return;
            
        }
        if (txtPatientEmail.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Please provide an Email ID field");
            return;
        ...
        if (!usernamePatternCorrect(txtPatientEmail.getText().trim())) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Please provide Numeric values in Age textfield");
                return;
            }
            ...
            if (radioBtnPatientInsuranceYes.isSelected()) {
                if (policyNumber.equals("")) {
                    JOptionPane.showMessageDialog(null, "Please provide policy number");
                    return;
                }
            ...
            patient.setAptDate(txtDate.getText());
            patient.setPatientId(patientId);
            patient.setPatientFirstName(firstName);
            patient.setPatientLastName(lastName);
            patient.setGender(gender);
            patient.setPatientMail(txtPatientEmail.getText().trim());
    ...
    private void btnFindInsuranceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFindInsuranceActionPerformed
        ...
        if (matchedCustomer != null) {
            ...
            JOptionPane.showMessageDialog(null, "Policy number does not match with provided SSN value");
    ...
    private void autopopulateFields(Patient patient) {
        ...
        txtHomePhone.setText(patient.getPhone());
        txtSSN.setText(patient.getSsn());
        txtAge.setText(patient.getPatientAge());
        txtAddress.setText(patient.getAddress());
        txtPatientEmail.setText(patient.getPatientMail());
    ...
    private boolean checkEmailDuplication(String patientEmail){
        ...
        for (HealthCenterEnterprise healthCenterEnterprise : healthCenterEnterprises) {
            List<Patient> patients = healthCenterEnterprise.getPatientDir().getPatients();
            for (Patient patient : patients) {
                if (patientEmail.equals(patient.getPatientMail())) {
                    isPatientFound = true;
                    break;
                }
